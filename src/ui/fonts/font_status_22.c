 ...
 * Size: 22 px
 * Bpp: 4
 * Opts: --font Montserrat-Bold-static.ttf --size 22 --bpp 4 --format lvgl --no-compress --force-fast-kern-format -r 0x20-0x7F -r 0xB0 --lv-font-name font_status_22 -o ../src/ui/fonts/font_status_22.c
 ******************************************************************************/
...
#ifndef FONT_STATUS_22
#define FONT_STATUS_22 1
#endif
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t font_status_22 = {
#else
lv_font_t font_status_22 = {
#endif

...
enum class MetricId : uint8_t {
  CO2, PM25, TVOC, NOX, PM01, PM10, PM003, TEMP, RHUM, COUNT
};
...
inline float value(const Measurement& m, MetricId id) {
  switch (id) {
    case MetricId::CO2:   return m.rco2;
    case MetricId::PM25:  return m.pm02;
    case MetricId::TVOC:  return m.tvocIndex;
    case MetricId::NOX:   return m.noxIndex;
    case MetricId::PM01:  return m.pm01;
    case MetricId::PM10:  return m.pm10;
    case MetricId::PM003: return m.pm003Count;
    case MetricId::TEMP:  return m.tempC();
    case MetricId::RHUM:  return m.humidity();
    default:              return NAN;
  }
}
...
inline Band band(const Measurement& m, MetricId id) {
  switch (id) {
    case MetricId::CO2:   return bandCo2(m.rco2);
    case MetricId::PM25:  return bandPm25(m.pm02);
    case MetricId::TVOC:  return bandTvoc(m.tvocIndex);
    case MetricId::NOX:   return bandNox(m.noxIndex);
    case MetricId::PM01:  return bandPm25(m.pm01);
    case MetricId::PM10:  return bandPm25(m.pm10);
    case MetricId::PM003: return bandPm25(m.pm003Count > 1000 ? 30 : 5);
    case MetricId::TEMP:  return bandTemp(m.tempC());
    case MetricId::RHUM:  return bandRhum(m.humidity());
    default:              return Band::NoData;
  }
}
